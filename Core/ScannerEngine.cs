    ...
    public class GameFolder : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public string DisplayVersion {
            get {
                ...
                var match = Regex.Match(Version, @"(v[\d\.]+).*(Build\s\d+)", RegexOptions.IgnoreCase);
        ...
        public bool ShowLaunchButton => !HasMissingRedists && !IsMoveInterrupted && !IsMoving;
        public bool ShowMoveButton => !IsMoving && !IsMoveInterrupted;

        public bool HasMap => File.Exists(Path.Combine(RootPath, ".rip_map.json")) || 
                             (!string.IsNullOrEmpty(GameSubFolderPath) && File.Exists(Path.Combine(GameSubFolderPath, ".rip_map.json")));
        public bool ShowBackupButton => !IsMoving;
        ...
        private void NotifyAll()
        {
            ...
            PropertyChanged?.Invoke(this, new System.ComponentModel.PropertyChangedEventArgs(nameof(IsMoveInterrupted)));
            PropertyChanged?.Invoke(this, new System.ComponentModel.PropertyChangedEventArgs(nameof(IsMoving)));
            ...
            PropertyChanged?.Invoke(this, new System.ComponentModel.PropertyChangedEventArgs(nameof(DisplayVersion)));
        }
