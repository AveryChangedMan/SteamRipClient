...
namespace SteamRipApp.Core
{
    ...
    public class DownloadManifest
    {
        ...
        public string SteamRipPageUrl { get; set; } = "";
        public long TotalBytes { get; set; }
        ...
        public async Task StartDownloadAsync()
        {
            ...
            try
            {
                ...
                if (_manifest != null && File.Exists(DestinationPath))
                {
                    ...
                    if (!string.IsNullOrEmpty(_manifest.SteamRipPageUrl)) SteamRipPageUrl = _manifest.SteamRipPageUrl;
                    if (!string.IsNullOrEmpty(_manifest.BuzzheavierPageUrl)) BuzzheavierPageUrl = _manifest.BuzzheavierPageUrl;
                }
                else
                {
                    ...
                    _manifest = new DownloadManifest
                    {
                        ...
                        SteamRipPageUrl = SteamRipPageUrl,
