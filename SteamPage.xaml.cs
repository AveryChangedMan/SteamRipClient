...
namespace SteamRipApp
{
    public sealed partial class SteamPage : Page
    {
        ...
        {
            UpdateSteamBtn.Visibility = GlobalSettings.IsSteamUpdateRequired ? Visibility.Visible : Visibility.Collapsed;
            await RefreshLibrary();
        }

        private async void UpdateSteam_Click(object sender, RoutedEventArgs e)
        {
